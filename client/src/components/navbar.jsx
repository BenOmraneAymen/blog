...
export default function Navbar(){
    return(
        <div className="bg-indigo-700 flex flex-row items-center justify-between h-1/10 w-full shadow-lg"> 
            <img src={logo} className="w-20 p-4 md:mr-16" />
            {/* <div className="flex flex-row items-center">
                <input type="search" name="" id="" className="hidden md:block rounded-l-lg md:rounded-lg  p-2 md:w-72 lg:w-80 h-10 outline-0" />
